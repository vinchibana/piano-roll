...
REPLACEMENTS = [
    ...
    ('<p class="credits-sig mono">piano-roll · 为耳朵而写的历史</p>', '<p class="credits-sig mono">piano-roll · history written for the ear</p>'),
